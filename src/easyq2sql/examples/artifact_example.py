#!/usr/bin/env python3
"""
Example demonstrating the artifact system in EasyQ2Sql.
...
from easyq2sql import Agent, UiComponent, User, AgentConfig
from easyq2sql.core.rich_components import ArtifactComponent
from easyq2sql.integrations.anthropic.mock import MockLlmService
from easyq2sql.core.interfaces import Agent, LlmService
...
async def main() -> None:
    ...
    document.querySelector('easyq2sql-chat').addEventListener('artifact-opened', (event) => {
