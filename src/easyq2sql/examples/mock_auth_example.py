...
from easyq2sql import AgentConfig, Agent
...
from easyq2sql.integrations.mock import MockLlmService
from easyq2sql.core.user import CookieEmailUserResolver, RequestContext
...
def create_demo_agent() -> Agent:
    ...
    user_resolver = CookieEmailUserResolver(cookie_name="easyq2sql_email")
...
async def demo_authentication():
    ...
    request_context = RequestContext(
        cookies={"easyq2sql_email": "alice@example.com"},
        headers={},
    ...
    bob_context = RequestContext(
        cookies={"easyq2sql_email": "bob@company.com"},
    ...
    print("• CookieEmailUserResolver extracts email from easyq2sql_email cookie")
