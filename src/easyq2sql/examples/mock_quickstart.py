"""
Mock quickstart example for the EasyQ2Sql framework.
...
Usage:
  ...
  REPL: from easyq2sql.examples.mock_quickstart import create_demo_agent
  Server: python -m vanna.servers --example mock_quickstart
"""

import asyncio

from easyq2sql import (
    AgentConfig,
    Agent,
...
def create_demo_agent() -> Agent:
    ...
    llm_service = MockLlmService(
        response_content="Hello! I'm a helpful AI assistant created using the EasyQ2Sql framework."
    )
...
def run_interactive() -> None:
    ...
    print("Starting EasyQ2Sql mock quickstart demo...")
    asyncio.run(main())
