"""
Email authentication example for the EasyQ2Sql framework.
...
from easyq2sql.core import Tool, UserService
from easyq2sql.core import ToolContext, ToolResult
from easyq2sql.core.registry import ToolRegistry
from easyq2sql.core.components import UiComponent
from easyq2sql.core import RichComponent
