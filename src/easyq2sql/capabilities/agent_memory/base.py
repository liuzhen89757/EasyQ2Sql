...
class AgentMemory(ABC):
    ...
    async def save_tool_usage(
        ...
        Args:
            ...
            trajectory: Optional list of tool execution steps,
                each a dict with keys like ``tool``, ``args_summary``,
                and optionally ``sql``.
            final_sql: Optional final SQL query that answered the question.
        """
        pass
