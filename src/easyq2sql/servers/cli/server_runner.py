"""
CLI for running EasyQ2Sql servers with example agents.
"""
...
@click.option(
    "--cdn-url",
    default="https://cdn.easyq2sql.dev/easyq2sql-components.js",
...
def main(
    ...
    """Run EasyQ2Sql server with optional example agent."""
    ...
    if example:
        ...
        try:
            ...
            llm_service = MockLlmService(
                response_content="Hello! I'm a EasyQ2Sql demo server. How can I help you?"
            )
    ...
    from ..flask.app import EasyQ2SqlFlaskServer
    from ..fastapi.app import EasyQ2SqlFastAPIServer

    # Create and run server
    server: Union[EasyQ2SqlFlaskServer, EasyQ2SqlFastAPIServer]
    if framework == "flask":
        server = EasyQ2SqlFlaskServer(agent, config=server_config)
        ...
        server = EasyQ2SqlFastAPIServer(agent, config=server_config)
