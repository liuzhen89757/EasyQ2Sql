"""
FastAPI route implementations for EasyQ2Sql.
"""
...
def register_chat_routes(
    ...
    @app.post("/api/easyq2sql/v1/chat_sse")
    async def chat_sse(
    ...
    @app.websocket("/api/easyq2sql/v1/chat_websocket")
    ...
    @app.post("/api/easyq2sql/v1/chat_poll")
    async def chat_poll(
        chat_request: ChatRequest, http_request: Request
    ) -> ChatResponse:
