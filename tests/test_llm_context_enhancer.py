...
from easyq2sql.core.enhancer.default import DefaultLlmContextEnhancer
...
from easyq2sql.core.llm.models import LlmMessage
from easyq2sql.core.llm.base import LlmService
...
class MockLlmService(LlmService):
    ...
    async def send_request(self, request):
        ...
        from easyq2sql.core.llm.models import LlmResponse, LlmResponseMessage
    ...
    async def stream_request(self, request):
        ...
        from easyq2sql.core.llm.models import LlmStreamChunk
...
async def test_custom_enhancer_system_prompt_is_called():
    ...
    from easyq2sql import Agent, AgentConfig
