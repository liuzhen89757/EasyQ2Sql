...
from easyq2sql.core.workflow.default import DefaultWorkflowHandler
...
from easyq2sql.core.storage import Conversation
from easyq2sql.core.tool import ToolContext
from easyq2sql.capabilities.agent_memory import ToolMemory, TextMemory
...
class TestStarterUI:
    ...
    async def test_starter_ui_single_component(
        ...
        class MockToolRegistryWithSQL:
            async def get_schemas(self, user):
                from easyq2sql.core.tool import ToolSchema
    ...
    async def test_starter_ui_user_view(
        ...
        assert "Welcome to EasyQ2Sql AI" in rich_text.content
