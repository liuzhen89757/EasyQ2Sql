...
from easyq2sql.integrations.azureopenai.llm import _is_reasoning_model
...
class TestAzureOpenAILlmServiceInitialization:
    ...
    @patch("easyq2sql.integrations.azureopenai.llm.AzureOpenAI")
...
class TestAzureOpenAILlmServicePayloadBuilding:
    ...
    def test_build_payload_includes_temperature_for_standard_model(
        ...
        from easyq2sql.core.llm import LlmRequest, LlmMessage
...
class TestImportError:
    ...
    def test_import_error_message(self):
        ...
        with patch.dict("sys.modules", {"openai": None}):
            ...
            if "easyq2sql.integrations.azureopenai.llm" in sys.modules:
                del sys.modules["easyq2sql.integrations.azureopenai.llm"]
