...
@customElement('easyq2sql-message')
export class EasyQ2SqlMessage extends LitElement {
  static styles = [
    vannaDesignTokens,
    css`
      :host {
      ...
      .message {
        ...
        border-radius: var(--easyq2sql-chat-bubble-radius);
      ...
      .message.assistant {
        ...
        border-radius: var(--easyq2sql-chat-bubble-radius) var(--easyq2sql-chat-bubble-radius) var(--easyq2sql-chat-bubble-radius) var(--vanna-space-2);
      }
      ...
      .message.user {
        ...
        border-radius: var(--easyq2sql-chat-bubble-radius) var(--easyq2sql-chat-bubble-radius) var(--vanna-space-2) var(--easyq2sql-chat-bubble-radius);
      ...
      .message.tool {
        ...
        border: 1px dashed var(--vanna-outline-default);
        ...
        border-radius: var(--vanna-space-1) var(--vanna-border-radius-md) var(--vanna-border-radius-md) var(--vanna-space-1);
      }

      :host([theme="dark"]) .message.tool {
        background: var(--vanna-background-highest);
        border-color: var(--vanna-outline-default);
        border-left-color: var(--vanna-accent-primary-stronger);
  ...
  @property() content = '';
  @property() type: 'user' | 'assistant' | 'tool' = 'user';
