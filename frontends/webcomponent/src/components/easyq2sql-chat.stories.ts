...
import './easyq2sql-chat';
import './easyq2sql-message';
import './plotly-chart';

const meta: Meta = {
  title: 'Components/EasyQ2SqlChat',
  component: 'easyq2sql-chat',
  parameters: {
    layout: 'fullscreen',
    backgrounds: {
      default: 'light',
...
export const WithConversation: Story = {
  ...
  render: (args) => {
    setTimeout(() => {
      const chat = document.querySelector('easyq2sql-chat') as any;
